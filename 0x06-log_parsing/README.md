# 0x06. Log Parsing
[Link to the project](https://intranet.hbtn.io/projects/474)
...
## Files
<code>0-stats.py</code>: the file with the script creates
<code>0-generator.py</code>: the file that generates the input string format
